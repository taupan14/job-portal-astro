...
const iniComponents = async () => {
  try {
    ...
    const el = document.querySelector("[data-slide-testimony-content]");
    let data = [];
    if (el) {
    ...
    const containers = document.querySelectorAll(
      "[data-slide-testimony-content] .splide__list",
    );

    containers.forEach((container, index) => {
      const limit =
        slideContainers[index].getAttribute("data-slide-testimony-content") ||
        "";

...
const iniComponents = async () => {
    try {
        ...
        const slideContainers = document.querySelectorAll('[data-slide-jobs]')
        const containers = document.querySelectorAll('[data-slide-jobs] .splide__list')
        
        containers.forEach((container, index) => {
            const limit = slideContainers[index].getAttribute('data-slide-jobs') || '' 

...
const initSlideRelatedService = async () => {
  ...
  document
    .querySelectorAll("[data-slide-related-services]")
    .forEach((slideEl) => {
      const slide = new Splide(slideEl, {
        // type: 'loop',
        autoWidth: true,
...
const initSlideRelatedProduct = async () => {
  ...
  document
    .querySelectorAll("[data-slide-related-products]")
    .forEach((slideEl) => {
      const slide = new Splide(slideEl, {
        // type: 'loop',
        autoWidth: true,
...
const initSlideTestimony = async () => {
  ...
  document.querySelectorAll("#section-testimonials").forEach((testimony) => {
    const testimonyAvatar = testimony.querySelector(
      "[data-slide-testimony-avatar]",
    );
    const testimonyContent = testimony.querySelector(
      "[data-slide-testimony-content]",
    );

    // Guard: skip jika salah satu elemen tidak ada di DOM
    // (terjadi saat data testimonial kosong dari CMS)
    if (!testimonyAvatar || !testimonyContent) return;
    ...
    const updateActiveSlide = () => {
      ...
      const activeSlide = testimonyAvatar.querySelector(
